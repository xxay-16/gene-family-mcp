...
WORKFLOW_ADVANCE_BATCH_SIZE = int(os.getenv('WORKFLOW_ADVANCE_BATCH_SIZE', '50'))
WORKFLOW_LEASE_SECONDS = int(os.getenv('WORKFLOW_LEASE_SECONDS', '120'))
MAX_SEQUENCE_LENGTH = int(os.getenv('MAX_SEQUENCE_LENGTH', '1000000'))
MAX_ACTIVE_JOBS = int(os.getenv('MAX_ACTIVE_JOBS', '1000'))
MAX_FASTA_INPUT_BYTES = int(os.getenv('MAX_FASTA_INPUT_BYTES', str(20 * 1024 * 1024)))
MAX_FASTA_RECORDS = int(os.getenv('MAX_FASTA_RECORDS', '100000'))
MAX_FASTA_SEQUENCE_LENGTH = int(
    os.getenv('MAX_FASTA_SEQUENCE_LENGTH', '10000000')
)
MAX_FASTA_TOTAL_RESIDUES = int(
    os.getenv('MAX_FASTA_TOTAL_RESIDUES', '50000000')
)
MAX_FASTA_HEADER_LENGTH = int(os.getenv('MAX_FASTA_HEADER_LENGTH', '1000'))
DATA_UPLOAD_MAX_MEMORY_SIZE = int(
    os.getenv('DATA_UPLOAD_MAX_MEMORY_SIZE', str(MAX_FASTA_INPUT_BYTES + 1024 * 1024))
)
